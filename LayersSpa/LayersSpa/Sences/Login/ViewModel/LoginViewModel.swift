...
//    private var useCase: LoginUseCase
//    
//    // إضافة خاصية لحالة تسجيل الدخول
//     var isLoggedIn: Bool {
//        get {
//            return Defaults.sharedInstance.isLoggedIn() // تحقق من الـ UserDefaults
//        }
//        set {
//            if newValue {
//                Defaults.sharedInstance.login() // تخزين حالة تسجيل الدخول في الـ UserDefaults
//            } else {
//                Defaults.sharedInstance.logout() // تخزين حالة تسجيل الخروج في الـ UserDefaults
//            }
//        }
//    }
//
...
//        self.state = .loading
//        if !Connectivity.isConnectedToInternet {
//            alertNetworkErrorMessage = "تحقق من اتصالك بالإنترنت"
//            return
//        }
//        
//        useCase.login(phoneNumber, password) { result in
...
//                Defaults.sharedInstance.userData = data
//                self.loginViewModels = data
//                self.isLoggedIn = true // تخزين الحالة في UserDefaults
//                
//            case .failure(let error):
//                switch error {
//                case .message(let errorDesc):
